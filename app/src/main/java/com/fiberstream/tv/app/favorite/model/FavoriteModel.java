package com.fiberstream.tv.app.favorite.model;

public class FavoriteModel {
    String id, title, icon, urlImage, kategori, jsonPackage, urlPlaystore, urlWeb;

    public FavoriteModel (String id,String title,String icon,String urlImage,String kategori,String jsonPackage,String urlPlaystore,String urlWeb){
        this.id = id;
        this.title = title;
        this.icon = icon;
