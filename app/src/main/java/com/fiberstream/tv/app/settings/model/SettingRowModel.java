...
package com.fiberstream.tv.app.settings.model;
...
public class SettingRowModel {
    ...
    @SerializedName("cards") private List<SettingModel> mCards;
    ...
    public List<SettingModel> getCards() {
        return mCards;
    }
