...
public abstract class AbstrackTextPresenter<T extends BaseCardView> extends Presenter {
     ...
     */
    public AbstrackTextPresenter(Context context) {
        mContext = context;
    }
     ...
     */
    public abstract void onBindViewHolder(CustomModel card, T cardView);
