...
//                    Toast.makeText(context, e.toString(), Toast.LENGTH_LONG).show();
    ...
    public ApiVolley(final Context context, JSONObject jsonBody, String requestMethod, String REST_URL,String flag, final VolleyCallback callback){
...
//                }
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                Map<String, String> params = new HashMap<String, String>();
                params.put("Content-Type", "application/json");
                params.put("Authorization", "key=AAAADfYzLT8:APA91bG-I1Wag_Fb4E4CVX2qIRiMF0nszHavKLB4sgeuPGuWWzyAtwxlVTjchkfez_evl5Y5U3GujxsTow_H4SI8dtC9KduqRcSOYKczi1P1Yvw-1ZSEgkK5QdE0n4SEyE4JiFi5zz_D");
                return params;
            }
            ...
            HttpsURLConnection.setDefaultHostnameVerifier(new HostnameVerifier(){
                public boolean verify(String hostname, SSLSession session) {
                    if (hostname.equalsIgnoreCase("www.myperkasa.com") ||
                            ...
                            hostname.equalsIgnoreCase("fcm.googleapis.com") ||
